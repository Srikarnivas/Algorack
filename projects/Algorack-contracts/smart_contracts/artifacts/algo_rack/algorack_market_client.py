...
class AlgorackMarketParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def delete(self) -> "_AlgorackMarketDelete":
        return _AlgorackMarketDelete(self.app_client)
...
class _AlgorackMarketDeleteTransaction:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class AlgorackMarketCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def delete(self) -> "_AlgorackMarketDeleteTransaction":
        return _AlgorackMarketDeleteTransaction(self.app_client)
...
class _AlgorackMarketDeleteSend:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class AlgorackMarketSend:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def delete(self) -> "_AlgorackMarketDeleteSend":
        return _AlgorackMarketDeleteSend(self.app_client)
...
class AlgorackMarketClient:
    """Client for interacting with AlgorackMarket smart contract"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = AlgorackMarketParams(self.app_client)
        self.create_transaction = AlgorackMarketCreateTransactionParams(self.app_client)
        self.send = AlgorackMarketSend(self.app_client)
        self.state = AlgorackMarketState(self.app_client)
    ...
    ) -> "AlgorackMarketClient":
        return AlgorackMarketClient(
    ...
    def new_group(self) -> "AlgorackMarketComposer":
        return AlgorackMarketComposer(self)
...
class AlgorackMarketMethodCallCreateParams(
    algokit_utils.AppClientCreateSchema, algokit_utils.BaseAppClientMethodCallParams[
        CreateApplicationArgs,
        str | None,
    ]
):
    """Parameters for creating AlgorackMarket contract using ABI"""
...
@dataclasses.dataclass(frozen=True)
class AlgorackMarketMethodCallDeleteParams(
    algokit_utils.BaseAppClientMethodCallParams[
        typing.Any,
        str | None,
    ]
):
    """Parameters for calling AlgorackMarket contract using ABI"""
...
class AlgorackMarketFactory(algokit_utils.TypedAppFactoryProtocol[AlgorackMarketMethodCallCreateParams, None, AlgorackMarketMethodCallDeleteParams]):
    """Factory for deploying and managing AlgorackMarketClient smart contracts"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = AlgorackMarketFactoryParams(self.app_factory)
        self.create_transaction = AlgorackMarketFactoryCreateTransaction(self.app_factory)
        self.send = AlgorackMarketFactorySend(self.app_factory)
    ...
    def deploy(
        ...
        *,
        ...
        create_params: AlgorackMarketMethodCallCreateParams | None = None,
        update_params: None = None,
        delete_params: AlgorackMarketMethodCallDeleteParams | None = None,
        existing_deployments: algokit_utils.ApplicationLookup | None = None,
        ignore_cache: bool = False,
        app_name: str | None = None,
        compilation_params: algokit_utils.AppClientCompilationParams | None = None,
        send_params: algokit_utils.SendParams | None = None,
    ) -> tuple[AlgorackMarketClient, algokit_utils.AppFactoryDeployResult]:
        ...
        return AlgorackMarketClient(deploy_response[0]), deploy_response[1]
...
class AlgorackMarketFactoryParams:
    """Parameters for creating transactions for AlgorackMarket contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = AlgorackMarketFactoryCreateParams(app_factory)
        self.update = AlgorackMarketFactoryUpdateParams(app_factory)
        self.delete = AlgorackMarketFactoryDeleteParams(app_factory)

class AlgorackMarketFactoryCreateParams:
    """Parameters for 'create' operations of AlgorackMarket contract"""
...
class AlgorackMarketFactoryUpdateParams:
    """Parameters for 'update' operations of AlgorackMarket contract"""
...
class AlgorackMarketFactoryDeleteParams:
    """Parameters for 'delete' operations of AlgorackMarket contract"""
...
class AlgorackMarketFactoryCreateTransaction:
    """Create transactions for AlgorackMarket contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = AlgorackMarketFactoryCreateTransactionCreate(app_factory)


class AlgorackMarketFactoryCreateTransactionCreate:
    """Create new instances of AlgorackMarket contract"""
...
class AlgorackMarketFactorySend:
    """Send calls to AlgorackMarket contract"""

    def __init__(self, app_factory: algokit_utils.AppFactory):
        self.app_factory = app_factory
        self.create = AlgorackMarketFactorySendCreate(app_factory)


class AlgorackMarketFactorySendCreate:
    """Send create calls to AlgorackMarket contract"""
    ...
    def bare(
        ...
        *,
        ...
        send_params: algokit_utils.SendParams | None = None,
        compilation_params: algokit_utils.AppClientCompilationParams | None = None,
    ) -> tuple[AlgorackMarketClient, algokit_utils.SendAppCreateTransactionResult]:
        """Creates a new instance using a bare call"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        ...
        return AlgorackMarketClient(result[0]), result[1]
    ...
    def create_application(
        ...
        *,
        ...
        send_params: algokit_utils.SendParams | None = None,
        compilation_params: algokit_utils.AppClientCompilationParams | None = None
    ) -> tuple[AlgorackMarketClient, algokit_utils.AppFactoryCreateMethodCallResult[None]]:
            ...
            return AlgorackMarketClient(client), algokit_utils.AppFactoryCreateMethodCallResult[None](
                **{
                    **result.__dict__,
...
class _AlgorackMarketDeleteComposer:
    def __init__(self, composer: "AlgorackMarketComposer"):
        self.composer = composer
    def delete_application(
        self,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> "AlgorackMarketComposer":
...
class AlgorackMarketComposer:
    """Composer for creating transaction groups for AlgorackMarket contract calls"""

    def __init__(self, client: "AlgorackMarketClient"):
        self.client = client
        self._composer = client.algorand.new_group()
        self._result_mappers: list[typing.Callable[[algokit_utils.ABIReturn | None], object] | None] = []

    @property
    def delete(self) -> "_AlgorackMarketDeleteComposer":
        return _AlgorackMarketDeleteComposer(self)
